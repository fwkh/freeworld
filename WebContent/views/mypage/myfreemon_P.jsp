...
<!-- 	<div class="load_box" style="display: none;">
	...
	<div id="header">
		<div class="header_top">
			<div class="box">
				...
				<div class="flow_text" style="padding-top: 10px;">
					<div class="flow_text_in"
						style="border: 0px solid red; line-height: 30px; height: 22px;">
				...
				<div class="top_menu w_top_menu">
					<ul class="cf">
						...
						<li><a href="/www.freemon.co.kr/mypage/myfreemon_P.html">마이프리몬<span
								class="arrow"></span></a>
							<ul class="top_depth2" style="display: none;">
								...
								<li><a href="#none" class="common-open_popup"
		...
		네비게이션 바 //        헤더 푸터 jsp로 대체진행해야함
		<div class="header_body">
			<div class="box">
				<h1 class="logo">
					<a href="/www.freemon.co.kr/index.html">프리월드</a>
				</h1>
				<div id="gnb">
					<nav>
						<ul class="gnb_in cf">

							<li class="menu_about gnb_depth1 "><a
								href="../project/projectSearch.html" class="gnb_depTxt"><em>프로젝트
										검색</em></a></li>
							<li class="menu_about gnb_depth1 "><a
								href="../project/projectMap" class="gnb_depTxt"><em>프로젝트
										맵</em></a></li>
							<li class="menu_about gnb_depth1 "><a
								href="../applicant/applicantsearch.html" class="gnb_depTxt"><em>제안
										및 지원 현황</em></a></li>
							 <li class="menu_about gnb_depth1 ">
                        	<a href="/home/freemonSupport" class="gnb_depTxt"><em>출장지원</em></a> 
                        </li>
							<li class="menu_about gnb_depth1 "><a
								href="../resume/resumeSearch.html" class="gnb_depTxt"><em>프로필
										관리</em></a></li>
		...
		<div class="footer_in box cf">
			<section>
				...
				<ul class="over_info cf">
					...
					<li class="col-12">디자인특허 제 30-2019-0048098호, 제
						30-2019-0048099호</li>
				</ul>
				<ul class="over_menu cf">
					...
					<li><a href="https://m.freemon.co.kr" class="link_mobile"
						style="display:;">모바일버전</a></li>
			...
			<section>
				<h3>고객센터</h3>
				<p class="f_tel eng">
					<a href="tel:18992951">1899-2951</a>
				</p>
				<p class="operate">평일 09:00 ~ 18:00 / 주말·공휴일 휴무</p>
				<div class="f_btn">
					<a href="/home/freemonService" target="_blank">서비스소개</a> <a
						href="/customer/noticeSearch">자주묻는질문</a> <a
						href="/customer/questionRegistForm">문의하기</a>
				</div>
			</section>
				<h3>앱 다운로드</h3>
				<section>
                <div class="app_btn cf">
                    <a href="https://play.google.com/store/apps/details?id=kr.insighton.freemonservice" target="_blank"
                        class="play"><em>구글플레이</em></a>
